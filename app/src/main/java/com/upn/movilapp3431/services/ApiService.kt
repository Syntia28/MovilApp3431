...
import com.upn.movilapp3431.entities.PokemonRes
...
interface ApiService {
    ...
    @GET("/contacts") //ubicacion de empoit de donde de optiene la informacionn (carpeta)
    suspend fun getContacts(): List<Contact>
@GET ("pokemon")
suspend fun getPokemon (): PokemonRes
